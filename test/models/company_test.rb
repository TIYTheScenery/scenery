...
class CompanyTest < ActiveSupport::TestCase
  ...
  test "Can find the next upcoming performance" do
    ...
    test_date = ShowTime.create!(zip_code: "27703", state: "NC", city: "Durham", address: "344 here st.", show_date: "Mon, 10 Apr 2018 10:57:49 -0400", begin_time: "2018-04-10 10:07:05 -0400")
    test_unit2 = Performance.create!(name: "This thing", description: "This thing happens")
    test_date2 = ShowTime.create!(zip_code: "27703", state: "NC", city: "Durham", address: "344 here st.", show_date: "Mon, 10 Apr 2015 10:57:49 -0400", begin_time: "2015-04-10 10:07:05 -0400")
    test_unit3 = Performance.create!(name: "This thing", description: "This thing happens")
    test_date3 = ShowTime.create!(zip_code: "27703", state: "NC", city: "Durham", address: "344 here st.", show_date: "Mon, 10 Apr 2019 10:57:49 -0400", begin_time: "2019-04-10 10:07:05 -0400")
