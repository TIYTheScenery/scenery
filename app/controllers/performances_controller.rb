class PerformancesController < ApplicationController
  ...
  def performance_params
    params.require(:performance).permit(:id, :name, :description, :owner_id, :company_id, :trailer_link, :ticket_link, :hero_image, :production_image_url, :profile_image_url, :hero_image_url,
